                ...
                <div className="doctor-profile-widget-fifteen">
                  ...
                  <div className="doc-content-bottom">
                    <div className="doc-content-split">
                      <Link to="/patient/doctor-profile">Recognized Certifications</Link>
                    </div>
                    <p>
                    An icon with text highlighting international recognition.
                    </p>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="item">
                <div className="doctor-profile-widget-fifteen">
                  ...
                  <div className="doc-content-bottom">
                    <div className="doc-content-split">
                      <Link to="/patient/doctor-profile">World-Class Lecturers</Link>
                    </div>
                    <p>
                      A brief description of your expert instructors.
                    </p>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="item">
                <div className="doctor-profile-widget-fifteen">
                  ...
                  <div className="doc-content-bottom">
                    <div className="doc-content-split">
                      <Link to="/patient/doctor-profile">Modern European Approach</Link>
                    </div>
                    <p>
                      Mention high standards.
                    </p>
