              ...
              <ul className="main-nav">
                ...
                <li className="has-submenu">
                  ...
                  <ul className="submenu">
                    ...
                    <li>
                      <Link to="/doctor/available-timings">Available Timing</Link>
                    </li>
                    <li>
                ...
                <li className="has-submenu">
                  ...
                  <ul className="submenu">
                    ...
                    <li className="has-submenu">
                      ...
                      <ul className="submenu inner-submenu">
                        <li>
                          <Link to="/patient/search-doctor1">Search Doctor 1</Link>
                        </li>
                        <li>
                          <Link to="/patient/search-doctor2">Search Doctor 2</Link>
                        </li>
                      </ul>
                    </li>
                    <li className="has-submenu">
                      ...
                      <ul className="submenu inner-submenu">
                        <li>
                          <Link to="/patient/doctor-profile">Doctor Profile 1</Link>
                        </li>
                        <li>
                          <Link to="doctor-profile-2.html">Doctor Profile 2</Link>
                        </li>
                      </ul>
                    </li>
                    <li className="has-submenu">
                  ...
                  <ul className="submenu">
                    ...
                    <li className="has-submenu">
                      ...
                      <ul className="submenu inner-submenu">
                        ...
                        <li>
                          <Link to="/pages/forgot-password">Forgot Password 1</Link>
                        </li>
                        <li>
                          <Link to="/pages/forgot-password2">Forgot Password 2</Link>
                        </li>
                        <li>
                  ...
                  <div className="togglesearch">
                    <form>
                      <div className="input-group">
                        ...
                        <button type="submit" className="btn btn-primary" onClick={directionPath}>
                          Search
                        </button>
                      </div>
                    </form>
